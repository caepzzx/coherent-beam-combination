...
didx=2;%index difference for lambda
...
for i=3
for scale=-2.17:0.01:1.2;%scale factor for different wavefront
...
save(['E:\Wavefront20150513\parsame',num2str(i),'_',num2str(scale),'.mat'],'para_same');%save result
clear u2 para_same;
end
end
system('shutdown -s');
...
Numofpoint=50;%Num of calcultaed point for a scale
filepath='E:\Wavefront20150513\diffwave\';

para_diff(Numofpoint)=struct('SR',[],'SRdl',[],'ECdl',[],...
    'rof80',[],'PV',[],'RMS',[],'GRMS',[],'GPV',[],'I2',[]);
for scale=0.01:0.01:1.2;%scale factor for different wavefront
for m=1:Numofpoint
