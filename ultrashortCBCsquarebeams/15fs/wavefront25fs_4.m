...
u1=zeros(size(X1));
u1=setu1_4(0,0,u1,w,deltad,dx1(k),L1(k),M,spectrum(k));
% 
...
filepath='D:\CBC\Wavefront20150513\25fs\parsame';
...
u1=setu1_4(scale*phi(:,:,k,idxphase),scale*phi(:,:,k,idxphase)...
...
Numofpoint=50;%Num of calcultaed point for a scale
filepath='D:\CBC\Wavefront20150513\25fs\diffwave\';
...
u1=setu1_4(scale*phi(:,:,k,idxphase1),scale*phi(:,:,k,idxphase2)...
   ,u1,w,deltad,dx1(k),L1(k),M,spectrum(k));
% 
% I1=abs(u1.*2); %src irradiance
% 
...
% 
% 
% u1=setu1_4tilt(tip(m),0,u1,w,deltad,dx1(k),L1(k),M,spectrum(k),lambda(k));
% % 
% % I1=abs(u1.*2); %src irradiance
% % 
% % figure
...
% 
% 
% u1=setu1_4tilt(0,tilt(m),u1,w,deltad,dx1(k),L1(k),M,spectrum(k),lambda(k));
% % 
% % I1=abs(u1.*2); %src irradiance
% % 
% % figure
